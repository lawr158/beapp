...
if strcmp(grp_proc_info.beapp_alt_user_input_location{1},'')
    ...
    [filepath,input_script_name] = fileparts(grp_proc_info.beapp_alt_user_input_location{1}); %RL added filepath
    run(fullfile(filepath, input_script_name)); clear input_script_name filepath; %RL changed to eval to run
end
