...
% 0 = off; 1 = mark samples with any channels above threshold bad; 2 = mark samples with percentage channels above threshold bad
...
% [] = use all possible segments, n = use specific number, skip file if file has fewer than n
